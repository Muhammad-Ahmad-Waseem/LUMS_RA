...
class Medical_Dataset(data.Dataset):
    def __init__(self, root1, root2, trainsize=512,mode='train',augmentation_prob=0.4):
        self.trainsize = trainsize
        self.image_root = root1
        self.gt_root = root2
...
def get_loader(root1,root2, batchsize, trainsize, num_workers=4, mode='train',augmentation_prob=0.4,shuffle=True, pin_memory=True):

    dataset = Medical_Dataset(root1= root1,root2 = root2, trainsize= trainsize,mode =mode, augmentation_prob=augmentation_prob)
